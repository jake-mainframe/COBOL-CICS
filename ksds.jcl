...
//SYSIN DD *
 ...
 DELETE HERC01.KICKS.MURACH.PRODUCT
 DELETE HERC01.KICKS.MURACH.INVOICE
 DELETE HERC01.KICKS.MURACH.INVCTL
 SET MAXCC = 0
 DEFINE CLUSTER                                       -
 ...
 DEFINE CLUSTER                                       -
      (NAME(HERC01.KICKS.MURACH.PRODUCT) VOLUMES(PUB002) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
    /* RECORDSIZE(39 39)     REC W/COMP-3  */         -
     ...
     DATA ( NAME(HERC01.KICKS.MURACH.PRODUCT.DATA))   -
    INDEX ( NAME(HERC01.KICKS.MURACH.PRODUCT.INDEX))
 DEFINE CLUSTER                                       -
      (NAME(HERC01.KICKS.MURACH.INVOICE) VOLUMES(PUB002) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
    /* RECORDSIZE(275 275)   REC W/COMP-3  */         -
     ...
     DATA ( NAME(HERC01.KICKS.MURACH.INVOICE.DATA))   -
    INDEX ( NAME(HERC01.KICKS.MURACH.INVOICE.INDEX))
 DEFINE CLUSTER                                       -
      (NAME(HERC01.KICKS.MURACH.INVCTL) VOLUMES(PUB002) -
       TRACKS(15 15)  INDEXED                         -
       SHAREOPTIONS(1 3) UNIQUE                       -
       RECORDSIZE(7 7)                                -
       KEYS(1 0)                                      -
      )                                               -
     DATA ( NAME(HERC01.KICKS.MURACH.INVCTL.DATA))    -
    INDEX ( NAME(HERC01.KICKS.MURACH.INVCTL.INDEX))
/*
//*
...
//SYSIN DD *
 REPRO INFILE(PRODUCT) OUTDATASET(HERC01.KICKS.MURACH.PRODUCT)
/*
//*
...
//SYSIN DD *
 REPRO INFILE(INVOICE) OUTDATASET(HERC01.KICKS.MURACH.INVOICE)
/*
//*
...
//SYSIN DD *
 REPRO INFILE(INVCTL) OUTDATASET(HERC01.KICKS.MURACH.INVCTL)
/*
//*
...
//SYSIN    DD *
 DEFINE ALTERNATEINDEX                                -
      (NAME(HERC01.KICKS.MURACH.INVOICE.AIX)          -
       RELATE(HERC01.KICKS.MURACH.INVOICE)            -
       VOLUMES(PUB002)                                -
     ...
     DATA ( NAME(HERC01.KICKS.MURACH.INVOICE.AIX.DATA)) -
    INDEX ( NAME(HERC01.KICKS.MURACH.INVOICE.AIX.INDEX))
 DEFINE PATH                                          -
      (NAME(HERC01.KICKS.MURACH.INVOICE.PATH)         -
       PATHENTRY(HERC01.KICKS.MURACH.INVOICE.AIX)     -
      )
 BLDINDEX INDATASET(HERC01.KICKS.MURACH.INVOICE)      -
           OUTDATASET(HERC01.KICKS.MURACH.INVOICE.AIX)
//
