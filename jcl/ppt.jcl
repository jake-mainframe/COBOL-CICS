//HERC01T  JOB CLASS=C,MSGCLASS=A,MSGLEVEL=(1,1)
//*
//ASM      EXEC PGM=IFOX00,
//            PARM='DECK,NOLIST'
...
*
         ...
         KIKPPT TYPE=ENTRY,PROGRAM=PAYMCOB,PGMLANG=CMDLVL
         KIKPPT TYPE=ENTRY,PROGRAM=LISTCOB,PGMLANG=CMDLVL
         KIKPPT TYPE=ENTRY,PROGRAM=MAINCOB,PGMLANG=CMDLVL
         KIKPPT TYPE=ENTRY,PROGRAM=KAJCCOB,PGMLANG=CMDLVL
